<template>
  <el-container>
    ...
    <el-dialog
      ...
      width="60%">
      <el-form :model="info" label-width="80px" size="medium" style="margin-left: 40px; margin-right: 40px"
        v-loading="info.loading">
        <el-form-item label="样例名:">
          <span>{{base_info.project_position}}</span>
        </el-form-item>
